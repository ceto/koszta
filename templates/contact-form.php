...
?>
<div id="respond" class="contact-wrap white-popup-block szaggat mfp-hide">
  <div id="infopan"></div>
  ...
  <form class="form-horizontal" action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="post">
    ...
    <div class="actions">
      ...
      <input type="submit" class="btn submitbtn" value="<?php _e('Elküldöm','roots'); ?>"> v. <span class="ion-android-call"></span> <a href="tel:+36707713778">+36 70 7713778</a></p>
